...
public class Function extends ValuePartial{
	public static final Value instance = new ValueFunction(name -> new ValueFunction(body -> new ValueFunction(arg -> body.call(new ValueFunction(envName -> {
		...
		return Compare.create(name, envName, envName, arg);
	})))));
}
